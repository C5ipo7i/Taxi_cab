...
train_df = pd.read_csv('/media/shuza/HDD_Toshiba/Taxi_NYC/train.csv',nrows=5000000)
...
model_path = '/media/shuza/HDD_Toshiba/Taxi_NYC/Models/V2'
verbosity = 1
num_epochs = 50
num_batches = 1028
validation = 0.005
...
train_model(model,X_train_mean,y,num_epochs,num_batches,validation,verbosity)
